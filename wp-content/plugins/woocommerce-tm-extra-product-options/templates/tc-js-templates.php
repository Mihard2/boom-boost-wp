...
<script class="tm-hidden" type="text/template" id="tmpl-tc-final-totals">
    <dl class="tm-extra-product-options-totals tm-custom-price-totals">
    	...
    	<div class="buying-card__price">
            <dt class="tm-options-totals buying-card__price-name">{{{ data.options_total }}}</dt>
    	    <dd class="tm-options-totals buying-card__price-count">
    	...
    	<div class="buying-card__price">
            <dt class="tm-final-totals buying-card__price-name">{{{ data.final_total }}}</dt>
    	    <dd class="tm-final-totals buying-card__price-count">
