...
final class THEMECOMPLETE_EPO_ADMIN_Global_base {
	...
	public function admin_menu() {
		...
		add_menu_page( esc_html__( 'Extra Product Options', 'woocommerce-tm-extra-product-options' ), esc_html__( 'Boost Options', 'woocommerce-tm-extra-product-options' ), 'manage_woocommerce', 'tcepo', array( $this, 'admin_epo_menu' ), 'dashicons-screenoptions', '54.6' );
