    ...
    <div class="top-content__card">
        <div class="buying-card">
            <div class="buying-card__content">
                ...
                <div class="buying-desc"><span>Fast delivery: 3—6 days.</span><span>Flexible price</span><span>Price for
                        3550 conquest cap</span></div>
            </div>
            ...
            </div><a class="link link-bg" href="#">add to basket</a><a class="link link-bg--transparent" href="#">buy
                right now</a>
        </div>
    </div> -->
    </div>
